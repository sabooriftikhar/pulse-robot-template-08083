  ...
  return (
    <div 
      ...
      className={cn(
        ...
        "lg:hover:bg-gradient-to-br lg:hover:from-white lg:hover:to-cyber-50",
        "transition-all duration-300"
      )}
      style={{ animationDelay: `${0.1 * index}s` }}
    >
      <div className="rounded-full bg-cyber-50 w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center text-cyber-500 mb-4 sm:mb-5">
        {icon}
      </div>
    ...
    <section className="py-12 sm:py-16 md:py-20 pb-0 relative bg-gray-50" id="features" ref={sectionRef}>
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          <div className="cyber-chip mx-auto mb-3 sm:mb-4 opacity-0 fade-in-element">
            <span>Capabilities</span>
          </div>
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Cutting-Edge Technology, <br className="hidden sm:block" />Human-Centered Design
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Powered by advanced digital solutions to create, innovate, and transform your business into a market leader.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          ...
          <FeatureCard
            ...
            description="Custom websites and applications built with modern technologies to deliver exceptional user experiences."
            index={1}
          />
          <FeatureCard
            ...
            title="UI/UX Design"
            description="Intuitive interfaces and seamless user experiences that keep your customers engaged and convert visitors into clients."
            index={2}
          />
          <FeatureCard
            ...
            description="Deep market research and competitive analysis to position your brand strategically in the marketplace."
            index={3}
          />
          <FeatureCard
            ...
            description="Lightning-fast websites and applications optimized for search engines and maximum conversion rates."
            index={4}
          />
          <FeatureCard
            ...
            description="Comprehensive marketing and growth strategies designed to scale your business and maximize ROI."
            index={5}
          />
        </div>
      </div>
